...
<?php endif; ?>
<?php if($this->countModules('top1') or $this->countModules('top2') or $this->countModules('top3') or $this->countModules('top4') or $this->countModules('top5')) : ?>
<div class="top">
<div class="container cols-<?php echo $countblock1; ?>">
<jdoc:include type="modules" name="promo" style="notag" />
<?php if($this->countModules('top1')) : ?>
<div class="column-1">
<jdoc:include type="modules" name="top1" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('top2')) : ?>
<div class="column-2">
<jdoc:include type="modules" name="top2" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('top3')) : ?>
<div class="column-3">
<jdoc:include type="modules" name="top3" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('top4')) : ?>
<div class="column-4">
<jdoc:include type="modules" name="top4" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('top5')) : ?>
<div class="column-5">
<jdoc:include type="modules" name="top5" style="tagmodule" />
</div>
<?php endif; ?>
</div>
</div>
...
<div class="user">
<div class="cols-<?php echo $countblock4; ?>">
